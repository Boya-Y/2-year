...
const TEXT = {
  ...
  profile: { nickname: '橘生✨', id: '小红薯号：9527888', bio: '吃喝玩乐✨ | 摄影📷 | 分享生活', statsFollow: '关注', statsFans: '粉丝', statsLikes: '获赞与收藏', follow: '关注', tabsNotes: '笔记', tabsCollect: '收藏', tabsLike: '赞过', cardAuthor: '橘生✨', likePrefix: '❤ ', cards: [ { title: '今日份自拍~✨', likes: '520', type: 'selfie' }, { title: '超好吃的火锅🍲', likes: '102', type: 'food' }, { title: '周末去看了展🎨', likes: '330', type: 'scenery' }, { title: '神仙奶茶!', likes: '89', type: 'food' }, { title: '求抱抱', likes: '999', type: 'selfie' } ] },
  ...
  home: { lateMsg: '（不知不觉，天色渐晚，电影也快放完了...）', should: '我应该...', leave: '天色太晚了，我先回家了', sheLeaveReply: '她：好，那你路上小心。', stay: '我能在你家过夜吗？', sheAngry: '她：滚😡！', dryLips: '我：入冬了，嘴唇稍微有点干...', sheLipstick: '她：（拿起唇膏）别动，我帮你涂。' },
  date: { year: '2023', month: '11月', day: '26', boyName: '伯牙', girlName: '橘子', line1: '2023年11月26日', line2: '这是一个难以忘怀的日子。', line3: '因为——', line4: '我和我喜欢的女生在一起了', clickContinue: '点击继续 >' },
  hair: { msg0: '（她刚洗完头从浴室出来...）', should: '我应该...', optRest: '赶紧上床吧，别感冒了', optBlow: '来，我给你吹头。', msg1a: '（走过去帮她吹头发...）', msg1b: '（吹风机的声音嗡嗡作响...）', msg1c: '她：我的头发好毛躁哦，不像别的那些女生...', optPraise: '宝宝的头发一点也不毛躁', optBad: '别的女生的头发都比你毛躁', buyAction: '我：（默默拿起手机下单了最新款吹风机）', buyResult: '我：刚才给你买了个更好的吹风机，过两天就到。', bad3: '她：哦...😐', bad4: '她：烦死了，毛躁不毛躁我不知道吗！', bad5: '她：挺好的，你还给几个妹妹吹过？🤔' },
  ...
  skin: { msg0: '（她正在给你擦护肤霜...）', should: '我应该...', optNo: '别给我擦了，我不要', optThanks: '谢谢宝宝～喜欢～', msg1a: '我：每次都是你给我擦，以后都让我给你擦。', msg1b: '（轻轻帮她擦拭脸颊...）', optComfort: '这样擦着舒服吗？', optDry: '宝宝你的皮肤好干燥', msg2a: '我：嘿嘿，我知道你的绿宝瓶快用完了，买了新的。', msg2b: '（掏出崭新的护肤品递给她）', bad3: '她：我的护肤品都用完了你也不给我买...', bad4: '她：你好恶心🤮', bad5: '她：还行吧，跟我的技术相比还是有差距。', bad6: '她：你还知道啊？爱与不爱真的很明显。' },
...
const ASSETS = {
  avatars: { me: 'assets/1.jpg', her: 'assets/2.jpg' },
  ...
  useEffect(() => {
    ...
    const updateScene1 = (interactive = true) => {
        ...
        if (s.scene1Reply.choiceMade) {
            ...
            if (s.scene1Reply.showQR && s.scene1Reply.timer > 480) {
